                                            ...
                                            <?php if($form['success'] == null){ ?>
                                                <?php if(!isset($_GET['u']) && !isset($_GET['t'])){ ?>
                                                    ...
                                                    <div class="col-md-12 col-sm-12 col-xs-12 text-center">
                                                        <input type="submit" name="activate1" id="submit" class="slide-btn login-btn" value="Resend">
                                                    </div>
                                                <?php }else{ ?>
                                                    <div class="col-md-12 col-sm-12 col-xs-12">
                                                    ...
                                                    <div class="col-md-12 col-sm-12 col-xs-12 text-center">
                                                        <input type="submit" name="activate2" id="submit" class="slide-btn login-btn" value="Activate">
                                                    </div>
                                                <?php } ?>
                                                <div class="col-md-12 col-sm-12 col-xs-12 text-center">
                                                    <div class="clear"></div>
