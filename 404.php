...
<head>
    ...
    <!-- Page Title  -->
    <title>Error 404 | <?php echo $core->title; ?></title>
    <!-- StyleSheets  -->
    <link rel="stylesheet" href="user/assets/css/dashlite.css?ver=1.4.0">
    <link id="skin-default" rel="stylesheet" href="user/assets/css/theme.css?ver=1.4.0">
</head>
...
<body class="nk-body bg-white npc-general pg-error">
                ...
                <div class="nk-content ">
                    <div class="nk-block nk-block-middle wide-md mx-auto">
                        <div class="nk-block-content nk-error-ld text-center">
                            <img class="nk-error-gfx" src="img/logo/error-404.svg" alt="">
                            <div class="wide-xs mx-auto">
                                ...
                                <a href="index.php" class="btn btn-lg btn-primary mt-2">Back To Home</a>
                            </div>
                        </div>
                    </div><!-- .nk-block -->
                </div>
    ...
    <!-- app-root @e -->
    <!-- JavaScript -->
    <script src="user/assets/js/bundle.js?ver=1.4.0"></script>
    <script src="user/assets/js/scripts.js?ver=1.4.0"></script>
